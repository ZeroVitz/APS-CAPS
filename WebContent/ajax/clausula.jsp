	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
			<div class="box-content">
				<h4 class="page-header">Clausulas</h4>
				...
				<label class="col-sm-2 control-label">Documento:</label>
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="Nombre de la clausula">
						</div>
						...
						<label class="col-sm-2 control-label">Numero Clausula:</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" placeholder="Numero de la clausula">
						</div>
