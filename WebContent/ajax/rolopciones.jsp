	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
			<div class="box-content">
				<h4 class="page-header">Roles y Opciones</h4>
				<form class="form-horizontal" role="form">
							<label class="col-sm-2 control-label">Rol:</label>	
							<div class="col-sm-3">
										<select class="populate placeholder" name="country" id="s2_country">
										<option value="">-- Seleccione un Rol --</option>
															<option value="fr">Administrador</option>
															<option value="us">Secretaria</option>
																</select>
															</div>
									<label class="col-sm-2 control-label">Opciones:</label>			       
										...
										<option value="">-- Seleccione una Opcion --</option>
															<option value="fr">Eliminar</option>
															<option value="us">Guardar</option>
																</select>
															</div>
		...
		<div class="box">
			<div class="box-header">
				<div class="box-name">
					...
					<span>Detalle de Rol y Opciones</span>
				</div>
				<div class="box-icons">
